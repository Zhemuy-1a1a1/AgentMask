...
[返回首页](./README.md) · [中文总说明](./README.zh-CN.md) · [Agent 列表](./agents/INDEX.md)
...
### Q1：我没有自己的 Agent，也能用吗？
只要你现在使用的工具支持自定义 Instructions / 系统提示词，就能试。
...
### Q4：这和升级版有什么区别？
公开标准版更轻，适合先跑起来。
升级版会更适合真实业务使用，通常会补更多模板、FAQ、SOP、案例。
