...
> 注：以下部分新增中文 Agent 目前先进入公开中文目录，英文别名后续再补。
...
| [周报生成Agent](./zh-CN/周报生成Agent.md) | 暂无英文别名 | 周报整理、汇总、对外汇报 |
| [对账Agent](./zh-CN/对账Agent.md) | 暂无英文别名 | 对账核对、异常定位、差异说明 |
| [招聘筛选Agent](./zh-CN/招聘筛选Agent.md) | 暂无英文别名 | 简历筛选、岗位匹配、初筛建议 |
| [电商运营Agent](./zh-CN/电商运营Agent.md) | 暂无英文别名 | 商品诊断、活动策划、数据复盘 |
| [社交媒体管理Agent](./zh-CN/社交媒体管理Agent.md) | 暂无英文别名 | 账号规划、内容排期、平台协同 |
| [销售台账Agent](./zh-CN/销售台账Agent.md) | 暂无英文别名 | 销售记录、漏斗追踪、状态汇总 |
...
| [知识库问答Agent](./zh-CN/知识库问答Agent.md) | 暂无英文别名 | 知识整理、问答生成、资料调用 |
| [读书陪跑Agent](./zh-CN/读书陪跑Agent.md) | 暂无英文别名 | 阅读计划、章节推进、复盘陪跑 |
